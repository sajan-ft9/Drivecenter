    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 flex text-gray-900">
                    <form class="w-full m-auto max-w-lg" action="{{ route('members.create') }}" method="POST"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input required name="name" value="{{ old('name') }}"
                                    ...
                                    id="grid-first-name" type="text" placeholder="e.g. Jane Foster">
                                @error('name')
                        ...
                        {{-- <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input required name="paid_amount" value="{{ old('paid_amount') }}"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="grid-password" type="number" placeholder="Rs.xxxx" required>
                                @error('paid_amount')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input required name="address" value="{{ old('address') }}"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="w-full">
                            <input
                                ...
                                id="grid-zip" type="submit" value="Add Member" placeholder="90210">
                        </div>
                    </form>
                </div>
            </div>
